...
local faction = FGC_CreateFaction("Ironforge", --UniqueTag (no whitespace)
                                  "Ironforge", --enUS faction name
                                  "IF", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Alliance") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Head_Dwarf_02")
...
faction:AddNPC("Mistina Steelshield","Ironforge",43,31)
...
quest:AddQuestAccepter("Mistina Steelshield")
