...
local faction = FGC_CreateFaction("DarkspearTrolls", --UniqueTag (no whitespace)
                                  "Darkspear Trolls", --enUS faction name
                                  "DT", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Horde") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Head_Troll_01")
...
faction:AddNPC("Vehena","Orgrimmar",37,87)
