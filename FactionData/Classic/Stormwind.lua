...
local faction = FGC_CreateFaction("Stormwind", --UniqueTag (no whitespace)
                                  "Stormwind", --enUS faction name
                                  "SW", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Alliance") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Head_Human_02")
...
faction:AddNPC("Clavicus Knavingham","Stormwind",44,73)
