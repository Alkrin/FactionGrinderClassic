...
local faction = FGC_CreateFaction("BootyBay", --UniqueTag (no whitespace)
                                  "Booty Bay", --enUS faction name
                                  "BB", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Bomb_01")
...
quest = faction:AddQuest("TraitortotheBloodsail","Traitor to the Bloodsail",500,0,true)
