...
local faction = FGC_CreateFaction("Gadgetzan", --UniqueTag (no whitespace)
                                  "Gadgetzan", --enUS faction name
                                  "GZ", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Bomb_03")
...
faction:AddNPC("Spigot Operator Luglunket","Tanaris",52,28)
...
quest = faction:AddQuest("WaratSea","War at Sea",500,0,true)
...
quest = faction:AddQuest("MendingOldWounds","Mending Old Wounds",250,0,true)
...
quest = faction:AddQuest("WaterPouchBounty","Water Pouch Bounty",10,0,true)
quest:SetIcon("Interface\\Icons\\INV_Drink_Milk_02")
quest:AddQuestAccepter("Spigot Operator Luglunket")
quest:AddItemObjective("Wastewander Water Pouch",8483,5,true)
