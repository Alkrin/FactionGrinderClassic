...
local faction = FGC_CreateFaction("GnomereganExiles", --UniqueTag (no whitespace)
                                  "Gnomeregan Exiles", --enUS faction name
                                  "GE", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Alliance") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Head_Gnome_02")
faction:SetStartingRep(3000)

--Quest NPCs
--  faction:AddNPC(englishName,englishZone,xCoord,yCoord)
faction:AddNPC("Bubulo Acerbus","Ironforge",73,47)
...
quest:AddQuestAccepter("Bubulo Acerbus")
