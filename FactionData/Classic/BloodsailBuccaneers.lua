...
local faction = FGC_CreateFaction("BloodsailBuccaneers", --UniqueTag (no whitespace)
                                  "Bloodsail Buccaneers", --enUS faction name
                                  "BB", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Helmet_66")
