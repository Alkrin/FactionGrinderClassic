...
local faction = FGC_CreateFaction("Undercity", --UniqueTag (no whitespace)
                                  "Undercity", --enUS faction name
                                  "UC", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Horde") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Head_Undead_01")
...
faction:AddNPC("Ralston Farnsley","Undercity",71,29)
...
quest:AddQuestAccepter("Ralston Farnsley")
