...
local faction = FGC_CreateFaction("Everlook", --UniqueTag (no whitespace)
                                  "Everlook", --enUS faction name
                                  "EL", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_Bomb_02")
...
quest = faction:AddQuest("MakingAmends","Making Amends",500,0,true)
