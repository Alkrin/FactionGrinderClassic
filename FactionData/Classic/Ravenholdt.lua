...
local faction = FGC_CreateFaction("Ravenholdt", --UniqueTag (no whitespace)
                                  "Ravenholdt", --enUS faction name
                                  "RH", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Box_03")


--Quest NPCs
--  faction:AddNPC(englishName,englishZone,xCoord,yCoord)
faction:AddNPC("Winstone Wolfe","Hillsbrad Foothills",71,45)
...
quest = faction:AddQuest("JunkboxesNeeded","Junkboxes Needed",75,50,true)
quest:SetIcon("Interface\\Icons\\INV_Box_03")
quest:AddQuestAccepter("Winstone Wolfe")
quest:AddItemObjective("Heavy Junkbox",16885,5,true)
