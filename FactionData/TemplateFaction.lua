...
local faction = FGC_CreateFaction("TemplateFaction", --UniqueTag (no whitespace)
                                  "Template Faction", --enUS faction name
                                  "TF", --enUS faction abbreviation
                                  "Classic", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\TEMP.BLP")
