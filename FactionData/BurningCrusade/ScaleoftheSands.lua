...
local faction = FGC_CreateFaction("ScaleoftheSands", --UniqueTag (no whitespace)
                                  "Scale of the Sands", --enUS faction name
                                  "SS", --enUS faction abbreviation
                                  "Wrath", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Misc_MonsterScales_13")
