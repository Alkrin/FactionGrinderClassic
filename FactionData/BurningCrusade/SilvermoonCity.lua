...
local faction = FGC_CreateFaction("SilvermoonCity", --UniqueTag (no whitespace)
                                  "Silvermoon City", --enUS faction name
                                  "SM", --enUS faction abbreviation
                                  "BurningCrusade", --Category / Expansion tag
                                  "Horde") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Mask_04")
...
faction:AddNPC("Sorim Lightsong","Silvermoon City",56,52)
...
quest:AddQuestAccepter("Sorim Lightsong")
