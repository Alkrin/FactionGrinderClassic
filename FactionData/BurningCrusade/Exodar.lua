...
local faction = FGC_CreateFaction("Exodar", --UniqueTag (no whitespace)
                                  "Exodar", --enUS faction name
                                  "Ex", --enUS faction abbreviation
                                  "BurningCrusade", --Category / Expansion tag
                                  "Alliance") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Mask_05")
...
faction:AddNPC("Dugiru","Exodar",63,67)
