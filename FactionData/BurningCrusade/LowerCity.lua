...
local faction = FGC_CreateFaction("LowerCity", --UniqueTag (no whitespace)
                                  "Lower City", --enUS faction name
                                  "LC", --enUS faction abbreviation
                                  "BurningCrusade", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Feather_06")


--Quest NPCs
--  faction:AddNPC(englishName,englishZone,xCoord,yCoord)
faction:AddNPC("Vekax","Shattrath City",52,18)
...
quest = faction:AddQuest("ArakkoaFeather","More Feathers",250,62,true)
quest:SetIcon("Interface\\Icons\\INV_Feather_06")
quest:AddRepRequirement("LowerCity",4,5,nil,nil)
quest:AddQuestAccepter("Vekax")
quest:AddItemObjective("Arakkoa Feather",25719,30,true)
