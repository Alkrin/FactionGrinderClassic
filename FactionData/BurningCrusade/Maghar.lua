...
local faction = FGC_CreateFaction("Maghar", --UniqueTag (no whitespace)
                                  "Mag'har", --enUS faction name
                                  "MH", --enUS faction abbreviation
...
faction:AddNPC("Warden Bullrok","Nagrand",56,38)
...
quest:AddQuestAccepter("Warden Bullrok")
