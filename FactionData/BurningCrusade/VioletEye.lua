...
local faction = FGC_CreateFaction("VioletEye", --UniqueTag (no whitespace)
                                  "The Violet Eye", --enUS faction name
                                  "VE", --enUS faction abbreviation
                                  "BurningCrusade", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Trinket_Naxxramas02")
