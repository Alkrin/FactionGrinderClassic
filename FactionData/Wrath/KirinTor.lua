...
local faction = FGC_CreateFaction("KirinTor", --UniqueTag (no whitespace)
                                  "Kirin Tor", --enUS faction name
                                  "KT", --enUS faction abbreviation
                                  "Wrath", --Category / Expansion tag
                                  "Both") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\Spell_Fire_MasterOfElements")
