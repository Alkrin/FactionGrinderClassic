...
local faction = FGC_CreateFaction("Frostborn", --UniqueTag (no whitespace)
                                  "The Frostborn", --enUS faction name
                                  "Fb", --enUS faction abbreviation
                                  "Wrath", --Category / Expansion tag
                                  "Alliance") --Side (Horde/Alliance/Both)

faction:SetIcon("Interface\\Icons\\INV_Hammer_01")


--Quest NPCs
--  faction:AddNPC(englishName,englishZone,xCoord,yCoord)
faction:AddNPC("Fjorlin Frostbrow","Storm Peaks",29,75)
...
quest = faction:AddQuest("Pushed Too Far","Pushed Too Far",250,77,false)
quest:SetIcon("Interface\\Icons\\INV_Hammer_01")
quest:AddQuestAccepter("Fjorlin Frostbrow")
quest:AddOtherObjective(1,"Stormpeak Wyrm slain",16)
